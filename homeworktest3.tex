...
\begin{axis}[
    ...
    xlabel={Num of Targets $M$},
    ylabel={Num of Robots $K$},]
   
    
    % Define the fill Zone
\coordinate (l1) at (0,0);
\coordinate (l2) at (900,900);
\coordinate (l3) at (0,900);
\filldraw[draw=black, fill=gray!20,opacity=0.3] (l1) -- (l2) -- (l3)--(l1);


% The lines
\addplot [smooth,blue,name path=AB,no marks,style= dashed]coordinates{(0,0)(2.5,2.5)(10,10)}; % actual curve
% Add comments
\addplot[black](5,3) circle (0pt) node[anchor=west] { $\#$ of robots};
\addplot[black](3.5,2) circle (0pt) node[anchor=west] { should $\geq$ $\#$ of Targets};
\addplot[red](1,7) circle (0pt) node[anchor=west] {Zone of Interest};
...
\addplot[black](2,2) circle (3pt) node[anchor=west] { P1-----2 combinations};
\addplot[black](2,4) circle (3pt) node[anchor=west] { P2-----14 combinations};
\addplot[black](2,8) circle (3pt) node[anchor=west] { P3-----254 combinations};
\draw [-stealth](20,0) -- (20,98);
% \addplot[black](2,2) circle (4pt) node[anchor=west] { P1};
% \addplot[black](1,0) circle (4pt) node[anchor=west] {P4};
% \addplot[black](1,1) circle (4pt) node[anchor=south] {P6};
% \addplot[black](0,1) circle (4pt) node[anchor=west] {P7};
...
\begin{axis}[
    ...
    % Define the fill Zone
\coordinate (l1) at (0,0);
\coordinate (l2) at (70,70);
\coordinate (l3) at (0,140);
\filldraw[draw=black, fill=green!20,opacity=0.3] (l1) -- (l2) -- (l3)--(l1);

\coordinate (l4) at (100,100);
\filldraw[draw=black, fill=gray!20,opacity=0.3] (l4) -- (l2) -- (l3)--(l4);

% The lines
\addplot [smooth,blue,name path=AB,no marks,style= dashed]coordinates{(0,0)(2.5,2.5)(10,10)}; % actual curve
% Add comments
\addplot[red](0.5,7) circle (0pt) node[anchor=west] {Brute Force Possible};
\addplot[red](5.5,4) circle (0pt) node[anchor=west] {Need SOM};
\addplot[red](7,7) circle (3pt) node[anchor=west] { };
\draw [-stealth](80,45) -- (80,95);
\end{axis}
\end{tikzpicture}
\end{center}
...
\addplot[red](3,3) circle (3pt) node[anchor=west] { T1};
\addplot[red](7,7) circle (3pt) node[anchor=west] { T2};
\end{axis}
\end{tikzpicture}
\end{center}
